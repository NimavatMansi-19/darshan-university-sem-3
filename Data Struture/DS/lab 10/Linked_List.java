    ...
    public void Sort_LL(){
        for(int i=0;i<count;i++){
            for(int j=0;j<count-i-1;j++){
                Node tempNode=first;
                Node tNode=first.link;
                int d;
                if(tempNode.data>tNode.data){
                    d=tempNode.data;
                    tNode.data=tempNode.data;
                    tempNode.data=d;
                }
                tempNode=tNode;
                tNode=tNode.link;
...
public class Linked_List{
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("Enter 8 to Sort linked list");
            System.out.println("Enter 9 to Swap node list");
            ...
            int b;
                ...
                if(a==9){
                    System.out.println("Enter which index you want to change:");
                    b=sc.nextInt();
                    node1.Swap_K(b);
                }
                if(a==10){
