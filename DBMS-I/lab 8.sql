...
SELECT REGION,YEAR,MIN(SALES_AMOUNT) AS TOTAL 
FROM SALES_DATA 
...
FROM SALES_DATA 
GROUP BY PRODUCT,YEAR,SALES_AMOUNT
...
SELECT TOP 3 SUM(SALES_AMOUNT) AS TOTAL,REGION 
FROM SALES_DATA
WHERE YEAR=2024
GROUP BY REGION
...
SELECT REGION,PRODUCT,COUNT(PRODUCT) AS COUNT
FROM SALES_DATA
