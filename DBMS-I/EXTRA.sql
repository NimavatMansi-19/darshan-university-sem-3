--https://github.com/dishavekariya/Students/blob/main/SQl_querry_questions.sql
...
SELECT C.cust_name,C.city,O.ord_no,O.ord_date,O.purch_amt,S.name,S.commission FROM CUSTOMER2 C 
LEFT JOIN
ORDERS O 
