...
-- AVG SALARY CITY WISE
SELECT CITY,AVG(SALARY) AS MAX_SAL FROM EMP GROUP BY CITY

--SECOND HIGHEST SALARY
SELECT MAX(SALARY) FROM EMP WHERE SALARY<(SELECT MAX(SALARY) FROM EMP)

--FIND EMP WHO JOINED IN THE FIRST HALF OF THE YEAR
SELECT * FROM EMP WHERE JOININGDATE<'1990-06-01' OR JOININGDATE>'1991-01-01' AND JOININGDATE<'1991-06-01'
SELECT * FROM EMP WHERE MONTH(JOININGDATE)<=6

--DISPLAY NAME AND SALARY OF EMP WHO JOINED LAST
